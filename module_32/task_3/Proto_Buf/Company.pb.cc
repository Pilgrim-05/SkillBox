...
PROTOBUF_CONSTEXPR Company::Company(
  ...
  , /*decltype(_impl_.economicactivity_)*/false} {}
...
const ::_pbi::DescriptorTable descriptor_table_Company_2eproto = {
    false, false, 127, descriptor_table_protodef_Company_2eproto,
    "Company.proto",
...
class Company::_Internal {
 public:
  ...
  static void set_has_economicactivity(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
...
Company::Company(const Company& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.economicactivity_){}};
  ...
  ::memcpy(&_impl_.foundationyear_, &from._impl_.foundationyear_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.economicactivity_) -
    reinterpret_cast<char*>(&_impl_.foundationyear_)) + sizeof(_impl_.economicactivity_));
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          _Internal::set_has_economicactivity(&has_bits);
          _impl_.economicactivity_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Company::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(5, this->_internal_economicactivity(), target);
  }
